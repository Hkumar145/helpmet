...
const CreateEquipment = ({ isOpen, onSave, onCancel }) => {
  ...
  const fetchEmployees = async () => {
    try {
      const response = await axios.get(`https://helpmet-back-end.onrender.com/companies/${companyID}/employees`);
  ...
  const fetchLocations = async () => {
    try {
      const response = await axios.get(`https://helpmet-back-end.onrender.com/companies/${companyID}/locations`);
  ...
  const handleCreateEquipment = async (equipment) => {
    try {
      await axios.post(`https://helpmet-back-end.onrender.com/companies/${companyID}/equipments`, equipment);
      onSave();
    } catch (error) {
