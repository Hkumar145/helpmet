...
const Home = () => {
  return (
    <div className='mainLand'>
      ...
      <div className="slimages landscape lanepor"><img src="../../images/incidentReportlan.svg" alt="" /></div>
      </div>
      ...
      <div className="secondb">
        ...
        <div className="slimages lanepor"><img src="../../images/safetyequiplan.svg" alt="" /></div>
      ...
      <div className="slimages landscape lanepor"><img src="../../images/injuryanalan.svg" alt="" /></div>
      </div>
      ...
      <div className="gr1">
        <div className="anal1">
          ...
          <div className="anal2">
            <img src="../../images/siteinjlan.svg" alt="" className='slofifimg' />
      ...
      <div className="filt">
        <div className="sam">
          ...
          <div className="slimages landscape lanepor sev sevspesh"><img src="../../images/graphlan.svg" alt="" /></div>
        </div>
      ...
      <div className="sam2">
        ...
        <div className="slimages landscape lanepor sevspesh seveig"><img src="../../images/safelan.svg" alt="" /></div>
        </div>
      </div>
